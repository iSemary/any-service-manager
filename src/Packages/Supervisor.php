...
class Supervisor extends Package implements Linux {
    use CommandExecutorTrait;

    private string $packageName;
    private string $packageVersionCommand;
    private string $password;

    public function __construct() {
        $this->packageName = "supervisor";
        $this->packageVersionCommand = "supervisord";
    ...
    public function version(): ?string {
        $check = $this->packageVersionCommand . " " . Linux::CHECK_VERSION_COMMAND;
