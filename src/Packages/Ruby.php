...
class Ruby extends Package implements Linux {
    use CommandExecutorTrait;
    
    private string $packageName;
    private string $packageInstallName;
    private string $password;

    public function __construct() {
        $this->packageName = "ruby";
        $this->packageInstallName = "ruby-full";
    ...
    public function install(): bool {
        $command = sprintf("echo '%s' | sudo -S %s $this->packageInstallName -y", $this->password, Linux::INSTALL_COMMAND);
    ...
    public function uninstall(): bool {
        $command = sprintf("echo '%s' | sudo -S %s $this->packageInstallName -y", $this->password, Linux::UNINSTALL_COMMAND);
