...
class PM2 extends Package implements Linux {
    ...
    public function install(): bool {
        $command = sprintf(Linux::NPM_INSTALL_COMMAND, $this->packageName);
    ...
    public function uninstall(): bool {
        $command = sprintf(Linux::NPM_REMOVE_COMMAND, $this->packageName);
    ...
    public function purge(): bool {
        $command = sprintf(Linux::NPM_PURGE_COMMAND, $this->packageName);
